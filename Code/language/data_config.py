...
# LLM Configuration
# Provider switch (groq | lmstudio)
LLM_PROVIDER = os.getenv('LLM_PROVIDER', 'groq').lower()

# LM Studio local server (OpenAI-compatible API) - kept for fallback/testing
LM_STUDIO_BASE_URL = os.getenv('LM_STUDIO_BASE_URL', 'http://192.168.0.106:1234/v1')
LM_STUDIO_MODEL_NAME = os.getenv('LM_STUDIO_MODEL_NAME', 'deepseek-r1-distill-qwen-1.5B')

# Groq cloud endpoint (OpenAI-compatible API)
GROQ_BASE_URL = os.getenv('GROQ_BASE_URL', 'https://api.groq.com/openai/v1')
GROQ_API_KEY = os.getenv('GROQ_API_KEY', '')
GROQ_MODEL_NAME = os.getenv('GROQ_MODEL_NAME', 'llama-3.1-8b-instant')

# Backward-compatible model name used by downstream code
LLM_MODEL_NAME = os.getenv(
    'LLM_MODEL_NAME',
    GROQ_MODEL_NAME if LLM_PROVIDER == 'groq' else LM_STUDIO_MODEL_NAME,
)
LLM_TEMPERATURE = 0.3
LLM_MAX_TOKENS = 1024
